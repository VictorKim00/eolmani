...
ITEMS = [
    ...
    {"code": "perilla",     "name": "깻잎",            "category": "채소", "unit": "50g",   "kamis_category_code": "200", "kamis_item_code": "253",  "kamis_kind_code": "00", "kamis_rank": "상품"},  # KAMIS 2026년 중순 조사단위 100g→50g 변경
    ...
    {"code": "paprika",         "name": "파프리카",       "category": "채소", "unit": "1개",   "kamis_category_code": "200", "kamis_item_code": "256",  "kamis_kind_code": "00", "kamis_rank": "상품"},
    ...
    {"code": "squid",             "name": "오징어",    "category": "수산", "unit": "1마리", "kamis_category_code": "600", "kamis_item_code": "619",  "kamis_kind_code": "03", "kamis_rank": "大"},  # 연근해 신선냉장(일일 조사). 냉동(04)·中등급은 조사 안 함
