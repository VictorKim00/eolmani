...
- **마지막 업데이트**: 2026-05-05 (Sprint 2 — 쿠팡 파트너스 링크 34개 등록 + 히어로 카드 + 브랜드 정체성)
...
**Sprint 2 완료**:
쿠팡 파트너스 링크 34/64개 등록 (쌀·채소·과일·축산 전체·수산 일부).
히어로 카드(🟢 최저렴 3개 상단 노출) 완료. 공정위 고지 문구 완료.
다음: 나머지 30개 파트너스 링크 등록 · 네이버 웹마스터 · 히어로 카드 이후 기능
...
친구 피드백 Sprint 2        ██████████  100%  ✅ 히어로 카드·파트너스 34개·공정위 고지·브랜드 정체성 완료
SEO + 애널리틱스            ████████░░   80%  ✅ 메타태그·sitemap·robots·GA4(G-1XQ2HKQE3M)·서치콘솔 완료 · 네이버 웹마스터 남음
쿠팡 파트너스 링크          █████░░░░░   53%  🛒 34/64개 등록 완료 · 30개 미등록
Week 4~5 (공산품)           ░░░░░░░░░░    0%
보류 (가격 알림)            ░░░░░░░░░░    0%
보류 (영수증 OCR)           ░░░░░░░░░░    0%
보류 (개인 CPI/슈링크)      ░░░░░░░░░░    0%
...
## 🛒 쿠팡 파트너스 링크 현황 (2026-05-05 기준)

> 링크 추가 후 반드시 `scripts/set_coupang_urls.py` 실행해야 DB 반영됨.

### ✅ 등록 완료 (34개)

| 카테고리 | 품목 |
|---------|------|
| 곡물 | 쌀20kg, 쌀10kg, 감자, 고구마 |
| 채소 | 배추(월동·봄), 무(월동·봄), 양파, 대파, 마늘, 시금치, 토마토, 당근 |
| 과일 | 사과, 배, 딸기, 바나나, 수박 |
| 축산 | 삼겹살, 목심, 앞다리, 등심, 안심, 양지, 갈비, 닭고기, 계란 |
| 수산 | 고등어, 갈치, 김, 오징어, 조기, 삼치 |
...
| 곡물 | 찹쌀, 콩 |
| 버섯 | 느타리버섯, 팽이버섯, 새송이버섯 |
| 채소 | 오이(3종), 호박(2종), 상추(2종), 청양고추, 깻잎, 양배추, 얼갈이배추, 열무, 풋고추, 붉은고추, 파프리카, 알배기배추, 브로콜리, 방울토마토 |
| 과일 | 감귤(비시즌), 참외, 멜론, 복숭아(시즌 7~9월), 포도 캠벨(시즌 8~9월), 포도 샤인머스켓(시즌 8~10월) |
| 수산 | 명태 |
...
1. **쿠팡 파트너스 링크 추가 등록** — 나머지 30개 품목 `scripts/set_coupang_urls.py` 채우기 → Claude에게 실행 요청
...
### 2026-05-05 — 히어로 카드 + 브랜드 정체성 + 파트너스 링크 34개

**히어로 카드**
- 메인 최상단 emerald 섹션: 🟢 품목 중 평년 대비 가장 저렴한 순 최대 3개 자동 표시
- 각 행: 품목명·절약폭(▼%)·현재가·쿠팡 직링크 버튼
- 🟢 품목 없는 날엔 카드 미표시

**브랜드 정체성**
- 푸터 "비상업 무료 서비스" → "장볼 때 타이밍을 알려주는 가격 신호등"

**쿠팡 링크 안내 문구**
- "쿠팡 링크는 실제 구매 패턴을 고려해 기준 단위와 유사한 용량으로 선택했습니다 · 가격은 현장에서 확인해 주세요"

**파트너스 링크 34개 DB 반영 (누적)**
- 추가: 돼지 목심·앞다리, 한우 4부위, 오징어·조기·삼치 (+9)
- 잔여: 30개 미등록 (버섯·오이·호박·상추·나머지 채소·과일·명태)
