...
- **마지막 업데이트**: 2026-05-05 (Sprint 2 — 쿠팡·네이버쇼핑 외부 쇼핑 링크 추가)
...
**Sprint 2 진행 중 (쇼핑 링크 완료 · 히어로 카드 남음)**:
쿠팡·네이버쇼핑 외부 검색 링크 상세 페이지에 추가 완료.
...
친구 피드백 Sprint 2        ███████░░░   70%  🛒 쿠팡 단독 링크 · 파트너스 구조 완료 · 히어로 카드 남음
SEO + 애널리틱스            ████░░░░░░   40%  ✅ 메타태그·sitemap·robots 완료 · GA4 ID 등록 남음
Week 4~5 (공산품)           ░░░░░░░░░░    0%
보류 (가격 알림)            ░░░░░░░░░░    0%
보류 (영수증 OCR)           ░░░░░░░░░░    0%
보류 (개인 CPI/슈링크)      ░░░░░░░░░░    0%
...
1. **쿠팡 파트너스 링크 수동 등록** — partners.coupang.com → 링크생성 → 상품탐색 → 품목별 검색 → 링크복사 → `scripts/set_coupang_urls.py` COUPANG_URLS에 붙여넣기 → Railway DB에 적용 (`DATABASE_URL=... uv run python scripts/set_coupang_urls.py`)
2. **SEO 최적화** — 구글/네이버 노출: meta description·Open Graph 태그 추가, 품목별 title 최적화, sitemap.xml, 구글 서치콘솔·네이버 웹마스터도구 등록
3. **방문자 분석 대시보드** — Google Analytics 4 또는 네이버 애널리틱스 연동. 방문자 수·유입 경로 한눈에 파악
4. **Sprint 2 히어로 카드** — 메인 최상단 🟢 신호 품목 1~3개 전단지형 강조 카드
5. **커뮤니티 홍보** — 에펨코리아·클리앙·82cook·맘카페 타겟별 포스팅. 5월 = 수박/참외/마늘 시즌 훅 활용
6. **Week 4~5: 공산품 섹션** — 참가격 API 연동, `/commodities` 라우트, 마트별 비교 카드
7. **U2: grey 신호등** — 데이터 없을 때 "보통" 오해 방지 (grey 처리)
